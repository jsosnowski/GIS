...
Do znalezienia cyklu Eulera w zadanym grafie w obu implementacjach zostanie zastosowany algorytm Fleury'ego, który prezentuje listing \ref{AlgorytmFleury}.
